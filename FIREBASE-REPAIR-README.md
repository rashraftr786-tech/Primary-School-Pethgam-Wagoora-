...
## 2026-09-19 integrated workflow additions
- Added `attachment-engine.js` and `storage.rules`.
- Added `Student-Leave.html` and `Leave-Management.html`.
- Added `HOI-Applications.html`.
- Added `auditHistory` support.
- Normalized Firebase SDK references to 10.14.1.
- See `ERP-AUDIT-REPORT.md` for verification boundaries.
